...
-->
			...
			<div class="member_email">
				...
				<input name="member_email" type="text" class="emailDomain" id="emailDomain" placeholder="입력" /> 
			...
			<div class="essentialtf">
				<input id="phone" name="member_address" type="text" class="cellphoneNo" placeholder="주소" maxlength="11"> 
				<input type="button" value="주소검색" id=""><br>
				<input id="phone" name="member_address" type="text" class="cellphoneNo" placeholder="상세주소" maxlength="11"> 
				<div id="phoneck" class="checkText"></div>
			</div>
			<div class="essentialtf">
				<input id="phone" name="member_phone" type="text" class="cellphoneNo" placeholder="전화번호" maxlength="13"> 
