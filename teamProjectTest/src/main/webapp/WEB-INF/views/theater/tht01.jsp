	...
	$('#favoriteTheaters a').on('click', function() {
        ...
        <div class="sect-city" style="display: flex; height: auto">
	        <ul>
				...
				<li class="on">
					<a href="javascript:void(0)" class="region">서울</a>
				</li>
			
				<li class="">
					<a href="javascript:void(0)" class="region">인천</a>
				</li>
			
				<li class="">
					<a href="javascript:void(0)" class="region">경기</a>
				</li>
			
				<li class="">
					<a href="javascript:void(0)" class="region">부산울산</a>
				</li>
			
				<li class="">
					<a href="javascript:void(0)" class="region">대전충청</a>
				</li>
			
				<li class="">
					<a href="javascript:void(0)" class="region">광주전라제주</a>
				</li>
			
				<li class="">
					<a href="javascript:void(0)" class="region">경상</a>
				</li>
			
				<li class="">
					<a href="javascript:void(0)" class="region">강원</a>
				</li>
			
				<li class="">
					<a href="javascript:void(0)" class="region">대구</a>
				</li>
