...
<body>
  <form action="${pageContext.request.contextPath}/login/login" method="post" class="loginForm" id="loginForm">
		...
		<div class="findIdPass">								
			<a href="findId" class="loginlink">아이디 찾기</a> 
			<a href="findPass" class="loginlink">비밀번호 찾기</a> 
			<a href="register" class="loginlink">회원가입</a>
		</div>
